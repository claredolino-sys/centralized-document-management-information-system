...
interface CustodianLoginProps {
  onBack?: () => void;
}

export function CustodianLogin({ onBack }: CustodianLoginProps) {
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Custodian login submitted");
  };
    ...
    <div className="size-full flex">
      ...
      <div className="w-full max-w-md bg-white flex flex-col items-center justify-center px-12 py-16">
        ...
        <div className="w-full">
          {/* Departmental Records Custodian Label */}
          <div className="mb-6">
            <Button 
